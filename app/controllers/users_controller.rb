class UsersController < ApplicationController
	...
	def sign_up
		request = RestClient.post 'https://sra-api.herokuapp.com/session', {:user =>{params[:user]}}
	...
	def create
		request = RestClient.post 'https://sra-api.herokuapp.com/users', {:email => params[:user][:email], :password => params[:user][:password], :password_confirmation => params[:user][:password_confirmation]}}
