...
When(/^I partially fill out the interview form$/) do
	#select 'tin', from: 'interview[roof]'
	#select 'adobe', from: 'interview[wall]'
	#select 'cement', from: 'interview[floor]'
	#select 'gas', from: 'interview[fuel_type]'
...
When(/^I remove a food item$/) do
    find_by_id("remove_consumed_foods_513fceb575b8dbbc21001506").click
end
...
Then(/^the form should reflect the removed item$/) do
    page.should have_no_css('div#food_div_513fceb575b8dbbc21001506')
end
